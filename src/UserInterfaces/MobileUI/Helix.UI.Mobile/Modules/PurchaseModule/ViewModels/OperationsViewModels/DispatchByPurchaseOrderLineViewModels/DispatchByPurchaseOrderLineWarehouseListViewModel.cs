...
namespace Helix.UI.Mobile.Modules.PurchaseModule.ViewModels.OperationsViewModels.DispatchByPurchaseOrderLineViewModels
{
    ...
    public partial class DispatchByPurchaseOrderLineWarehouseListViewModel : BaseViewModel
    {
        ...
        public DispatchByPurchaseOrderLineWarehouseListViewModel(IHttpClientService httpClientService, IWarehouseService warehouseService)
        {
            Title = "Ambar Listesi";
