...
{
    public partial class DispatchBySalesOrderLineLineChangeBottomSheetViewModel : BaseViewModel
    {
        [ObservableProperty]
        ...
        public DispatchBySalesOrderLineLineChangeBottomSheetViewModel()
        {
