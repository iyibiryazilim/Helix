...
public partial class ProductDetailOutputTransactionListViewModel : BaseViewModel
{
	...
	public ObservableCollection<ProductTransactionLine> ProductOutputTransactionListItems { get; } = new();
	public Command GetProductOutputTransactionListItemsCommand { get; }
	public Command SearchCommand { get; }
	public ProductDetailOutputTransactionListViewModel(IHttpClientService httpClient, IProductTransactionLineService productTransactionLineService)
	{
		Title = "Çıkış Hareketleri";
		_httpClient = httpClient;
		_productTransactionLineService = productTransactionLineService;

		GetProductOutputTransactionListItemsCommand = new Command(async () => await LoadData());
