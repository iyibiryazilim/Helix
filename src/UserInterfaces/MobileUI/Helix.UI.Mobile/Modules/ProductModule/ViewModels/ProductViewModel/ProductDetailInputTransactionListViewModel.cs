...
public partial class ProductDetailInputTransactionListViewModel : BaseViewModel
{
	...
	public ObservableCollection<ProductTransactionLine> ProductInputTransactionListItems { get; } = new();
	public Command GetProductInputTransactionListItemsCommand { get; }
	public Command SearchCommand { get; }

	public ProductDetailInputTransactionListViewModel(IHttpClientService httpClient, IProductTransactionLineService productTransactionLineService)
	{
		Title = "Giriş Hareketleri";
		_httpClient = httpClient;
		_productTransactionLineService = productTransactionLineService;

		GetProductInputTransactionListItemsCommand = new Command(async () => await LoadData());
