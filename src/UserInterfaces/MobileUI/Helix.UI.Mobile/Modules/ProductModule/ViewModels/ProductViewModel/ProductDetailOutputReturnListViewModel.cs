...
public partial class ProductDetailOutputReturnListViewModel : BaseViewModel
{
	...
	public ObservableCollection<ProductTransactionLine> ProductTransactionOutputReturnListItems { get; } = new();
	public Command GetProductTransactionOutputReturnListItemsCommand { get; }
	public Command SearchCommand { get; }

	public ProductDetailOutputReturnListViewModel(IHttpClientService httpClient, IProductTransactionLineService productTransactionLineService)
	{
		Title = "Çıkış İadeleri";
		_httpClient = httpClient;
		_productTransactionLineService = productTransactionLineService;

		GetProductTransactionOutputReturnListItemsCommand = new Command(async () => await LoadData());
