...
public partial class ProductDetailSalesDispatchListViewModel : BaseViewModel
{
	...
	public ObservableCollection<ProductTransactionLine> ProductTransactionSalesDispatchListItems { get; } = new();
	public Command GetProductTransactionSalesDispatchListItemsCommand { get; }
	public Command SearchCommand { get; }
	public ProductDetailSalesDispatchListViewModel(IHttpClientService httpClient, IProductTransactionLineService productTransactionLineService)
	{
		Title = "Satış İrsaliyesi";
		_httpClient = httpClient;
		_productTransactionLineService = productTransactionLineService;

		GetProductTransactionSalesDispatchListItemsCommand = new Command(async () => await LoadData());
