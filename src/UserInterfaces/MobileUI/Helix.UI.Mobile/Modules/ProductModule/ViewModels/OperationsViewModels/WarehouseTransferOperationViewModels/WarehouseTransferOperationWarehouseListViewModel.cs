...
public partial class WarehouseTransferOperationWarehouseListViewModel : BaseViewModel
{
	...
	async Task GoToWarehouseTransferOperationViewAsync()
	{
		...
		{
			await Shell.Current.GoToAsync($"{nameof(WarehouseTransferOperationView)}", new Dictionary<string, object>
			{
