...
namespace Helix.UI.Mobile.Modules.ProductModule.ViewModels.OperationsViewModels.TransferTransactionOperationViewModels
{
	...
	public partial class EntryWarehouseSelectViewModel : BaseViewModel
	{
		...
		public EntryWarehouseSelectViewModel(IHttpClientService httpClientService, IWarehouseService warehouseService, ICustomQueryService customQueryService)
		{
			Title = "Giriş Ambar Listesi";
		...
		async Task GoToTransaction()
		{
			...
			{
				TransferTransactionModel.EntryWarehouse = SelectedWarehouse;
				await Shell.Current.GoToAsync($"{nameof(TransferTransactionSummaryView)}", new Dictionary<string, object>
				{
