...
{
	public partial class ExitWarehouseSelectViewModel : BaseViewModel
	{
		...
		public TransferTransactionModel TransferTransaction = new();
		...
		public ExitWarehouseSelectViewModel(IHttpClientService httpClientService, IWarehouseService warehouseService, ICustomQueryService customQueryService)
		{
		...
		async Task GoToTransaction()
		{
			...
			{
				TransferTransaction.ExitWarehouse = SelectedWarehouse;
				await Shell.Current.GoToAsync($"{nameof(ExitProductSelectView)}", new Dictionary<string, object>
				{
					[nameof(TransferTransactionModel)] = TransferTransaction
				});
			}
