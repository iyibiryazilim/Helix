...
namespace Helix.UI.Mobile.Modules.BaseModule.ViewModels.CurrentViewModel
{
	...
	public partial class CurrentOutputListViewModel : BaseViewModel
	{
		...
		public CurrentOutputListViewModel(ISupplierTransactionLineService supplierTransactionLineService, IHttpClientService httpClientService)
		{
		...
		async Task LoadMoreAsync()
		{
			...
			try
			{
				...
				CurrentPage++;
				var result = await _supplierTransactionLineService.GetOutputTransactionLineByCurrentIdAsync(httpClient, SearchText, OrderBy, Current.ReferenceId, CurrentPage, PageSize);
				if (result.Data.Any())
				{
