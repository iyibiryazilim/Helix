...
namespace Helix.UI.Mobile.Modules.BaseModule.ViewModels.CurrentViewModel
{
	...
	public partial class CurrentPurchaseDispatchListViewModel : BaseViewModel
	{
		...
		public CurrentPurchaseDispatchListViewModel(ISupplierTransactionLineService supplierTransactionLineService, IHttpClientService httpClientService)
		{
		...
		async Task LoadMoreAsync()
		{
			...
			try
			{
				...
				CurrentPage++;
				var result = await _supplierTransactionLineService.GetTransactionLineByTransactionTypeAsync(httpClient, SearchText, OrderBy, Current.ReferenceId, "1", CurrentPage, PageSize);
				if (result.Data.Any())
				{
