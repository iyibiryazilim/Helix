...
namespace Helix.UI.Mobile.Modules.BaseModule.ViewModels.CurrentViewModel
{
	...
	public partial class CurrentPurchaseReturnListViewModel : BaseViewModel
	{
		...
		public CurrentPurchaseReturnListViewModel(ISupplierTransactionLineService supplierTransactionLineService, IHttpClientService httpClientService)
		{
			Title = "Satınalma İadeleri";
		...
		async Task LoadMoreAsync()
		{
			...
			try
			{
				...
				CurrentPage++;
				var result = await _supplierTransactionLineService.GetTransactionLineByTransactionTypeAsync(httpClient, SearchText, OrderBy, Current.ReferenceId, "6", CurrentPage, PageSize);
				if (result.Data.Any())
				{
