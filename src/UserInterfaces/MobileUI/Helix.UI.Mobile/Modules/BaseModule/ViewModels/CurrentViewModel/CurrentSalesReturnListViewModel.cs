...
namespace Helix.UI.Mobile.Modules.BaseModule.ViewModels.CurrentViewModel
{
	...
	public partial class CurrentSalesReturnListViewModel : BaseViewModel
	{
		...
		public CurrentSalesReturnListViewModel(ISupplierTransactionLineService supplierTransactionLineService, IHttpClientService httpClientService)
		{
		...
		async Task LoadMoreAsync()
		{
			...
			try
			{
				...
				CurrentPage++;
				var result = await _supplierTransactionLineService.GetTransactionLineByTransactionTypeAsync(httpClient, SearchText, OrderBy, Current.ReferenceId, "2,3", CurrentPage, PageSize);
				if (result.Data.Any())
				{
