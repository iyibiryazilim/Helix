...
namespace Helix.UI.Mobile.Modules.BaseModule.ViewModels.CurrentViewModel
{
	...
	public partial class CurrentInputListViewModel : BaseViewModel
	{
		...
		public CurrentInputListViewModel(ISupplierTransactionLineService supplierTransactionLineService, IHttpClientService httpClientService)
        {
		...
		async Task LoadMoreAsync()
		{
			...
			try
			{
				...
				CurrentPage++;
				var result = await _supplierTransactionLineService.GetInputTransactionLineByCurrentIdAsync(httpClient, SearchText, OrderBy, Current.ReferenceId,CurrentPage, PageSize);
				if (result.Data.Any())
				{
