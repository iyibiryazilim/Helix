...
public partial class FastProductionSelectWarehouseListViewModel : BaseViewModel
{
	...
	[RelayCommand]
	async Task GoToFastProductionSelectProductListViewAsync()
	{
		if (SelectedWarehouse is not null)
		{
			await Shell.Current.GoToAsync($"{nameof(FastProductionSelectProductListView)}", new Dictionary<string, object>
			{
