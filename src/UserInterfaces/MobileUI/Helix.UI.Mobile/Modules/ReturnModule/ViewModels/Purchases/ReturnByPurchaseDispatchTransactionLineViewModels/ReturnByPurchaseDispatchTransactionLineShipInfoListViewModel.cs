...
namespace Helix.UI.Mobile.Modules.ReturnModule.ViewModels.Purchases.ReturnByPurchaseDispatchTransactionLineViewModels
{
	...
	public partial class ReturnByPurchaseDispatchTransactionLineShipInfoListViewModel : BaseViewModel
	{
		...
		public ReturnByPurchaseDispatchTransactionLineShipInfoListViewModel(IHttpClientService httpClientService, IShipInfoService shipInfoService)
		{
		...
		async Task GetShipInfosAsync()
		{
			...
			try
			{
				...
				{
					await Shell.Current.GoToAsync($"{nameof(ReturnByPurchaseDispatchTransactionLineWarehouseListView)}", new Dictionary<string, object>
					{
						["ShipInfo"] = SelectedShipInfo,
