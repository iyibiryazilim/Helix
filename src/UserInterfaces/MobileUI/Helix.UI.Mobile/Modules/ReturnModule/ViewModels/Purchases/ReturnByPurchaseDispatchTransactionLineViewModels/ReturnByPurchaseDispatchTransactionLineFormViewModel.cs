...
namespace Helix.UI.Mobile.Modules.ReturnModule.ViewModels.Purchases.ReturnByPurchaseDispatchTransactionLineViewModels
{
	...
	public partial class ReturnByPurchaseDispatchTransactionLineFormViewModel : BaseViewModel
	{
        ...
        public ReturnByPurchaseDispatchTransactionLineFormViewModel(IHttpClientService httpClientService, IDriverService driverService, ICarrierService carrierService, ISpeCodeService speCodeService, IPurchaseReturnDispatchTransactionService purchaseReturnDispatchTransactionService)
        {
            Title = "Form";
