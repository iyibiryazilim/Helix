...
namespace Helix.UI.Mobile.Modules.ReturnModule.ViewModels.Sales.ReturnBySalesDispatchTransactionViewModels
{
    ...
    public partial class ReturnBySalesDispatchTransactionSelectedLineListViewModel : BaseViewModel
    {
        [ObservableProperty]
        ...
        public ReturnBySalesDispatchTransactionSelectedLineListViewModel()
        {
