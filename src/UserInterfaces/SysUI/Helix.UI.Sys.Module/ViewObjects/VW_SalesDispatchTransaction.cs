...
{
    [Persistent("View_SalesDispatchTransaction_003_01")]
    [NavigationItem("Sales Management")]
    [DefaultClassOptions]
    public class VW_SalesDispatchTransaction : XPLiteObject
    {
        public VW_SalesDispatchTransaction(Session session) : base(session)
        {
        }
