...
public class PurchaseDispatchTransactionInsertedIntegrationEvent : IntegrationEvent
{
    ...
    List<PurchaseDispatchTransactionLineDto> Lines { get; set; } = new List<PurchaseDispatchTransactionLineDto>();
