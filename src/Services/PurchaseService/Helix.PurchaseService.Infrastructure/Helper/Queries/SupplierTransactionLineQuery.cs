...
{
    public class SupplierTransactionLineQuery : BaseQuery
    {
        public SupplierTransactionLineQuery(IConfiguration configuration) : base(configuration)
        {
        }
        ...
        public class SupplierTransactionLineOrderBy
        {
