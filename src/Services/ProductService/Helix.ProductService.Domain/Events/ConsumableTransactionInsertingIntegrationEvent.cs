...
namespace Helix.ProductService.Domain.Events
{
    public class ConsumableTransactionInsertingIntegrationEvent : IntegrationEvent
    {
        ...
        public ConsumableTransactionInsertingIntegrationEvent(int referenceId, DateTime transactionDate, string transactionTime, int convertedTime, int orderReference, string code, short groupType, short iOType, short transactionType, int? warehouseNumber, int? currentReferenceId, string? currentCode, string description, string speCode, string doCode, string docTrackingNumber, List<ConsumableTransactionLineDto> lines)
        {
