...
{
	public Task<DataResult<IEnumerable<WarehouseTransaction>>> GetTransactionsByWarehouseNumber(int number, string search, string orderBy, int currentPage, int pageSize);
