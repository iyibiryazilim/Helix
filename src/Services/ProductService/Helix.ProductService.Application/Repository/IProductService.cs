...
namespace Helix.ProductService.Application.Repository
{
	public interface IProductService
	{
        ...
        public Task<DataResult<IEnumerable<Product>>> GetAlternativeProductList(int id,string search, string orderBy, int page, int pageSize);
        public Task<DataResult<IEnumerable<ProductCustomerAndSupplier>>> GetCustomerAndSupplierList(int id, string search, string orderBy, int page, int pageSize);
