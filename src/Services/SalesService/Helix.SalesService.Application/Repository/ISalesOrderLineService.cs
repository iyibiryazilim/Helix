...
public interface ISalesOrderLineService
{
    ...
    public Task<DataResult<IEnumerable<SalesOrderLine>>> GetWaitingSalesOrdersByCurrentIdAndWarehouseNumberAndShipInfoAsync(int id, int warehouseNumber,int shipInfoReferenceId, string search, string orderBy, int page, int pageSize);
