...
namespace Helix.ProductionService.Domain.Events
{
	public class OutSourceWorkOrderInsertActualQuantityIntegrationEvent : IntegrationEvent
	{
		...
		public OutSourceWorkOrderInsertActualQuantityIntegrationEvent(int workOrderReferenceId, int productReferenceId, double actualQuantity, int subUnitsetReferenceId, short calculatedMethod, bool ısIncludeSideProduct)
		{
