...
public class WorkOrderInsertingIntegrationEvent : IntegrationEvent
{
	...
	public WorkOrderInsertingIntegrationEvent(int workOrderReferenceId, int productReferenceId, double actualQuantity, int subUnitsetReferenceId, short calculatedMethod, bool ısIncludeSideProduct)
	{
