...
namespace Helix.LBSService.PostConsumer.Events
{
	public class OutSourceWorkOrderStopTransactionInsertingIntegrationEventHandler : IIntegrationEventHandler<OutSourceWorkOrderStopTransactionInsertingIntegrationEvent>
	{
		...
		private readonly ILogger<OutSourceWorkOrderStopTransactionInsertingIntegrationEventHandler> _logger;

		public OutSourceWorkOrderStopTransactionInsertingIntegrationEventHandler(IHttpClientService httpClientService, ILogger<OutSourceWorkOrderStopTransactionInsertingIntegrationEventHandler> logger)
		{
			_httpClientService = httpClientService;
			_logger = logger;
		}

		public async Task Handle(OutSourceWorkOrderStopTransactionInsertingIntegrationEvent @event)
		{
