...
namespace Helix.LBSService.PostConsumer.Events
{
	public class OutSourceWorkOrderInsertActualQuantityIntegrationEventHandler : IIntegrationEventHandler<OutSourceWorkOrderInsertActualQuantityIntegrationEvent>
	{
		...
		private readonly ILogger<OutSourceWorkOrderInsertActualQuantityIntegrationEventHandler> _logger;

		public OutSourceWorkOrderInsertActualQuantityIntegrationEventHandler(IHttpClientService httpClientService, ILogger<OutSourceWorkOrderInsertActualQuantityIntegrationEventHandler> logger)
		{
			_httpClientService = httpClientService;
			_logger = logger;
		}

		public async Task Handle(OutSourceWorkOrderInsertActualQuantityIntegrationEvent @event)
		{
