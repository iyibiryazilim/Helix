...
namespace Helix.LBSService.EventConsumer.PurchaseDispatch
{
	public class PurchaseReturnDispatchTransactionConsumer : IDisposable
	{
		...
		public PurchaseReturnDispatchTransactionConsumer(ILG_PurchaseReturnDispatchTransactionService purchaseReturnDispatchTransactionService, HttpClient httpClient)
		{
		...
		private async Task<bool> PostDtoToApiAsync(PurchaseReturnDispatchTransactionDto dto)
		{
			try
			{
		...
		private void GetMessageFromQueue()
		{
			try
			{
				...
				PurchaseReturnDispatchTransactionDto dto = new PurchaseReturnDispatchTransactionDto();
				...
				consumer.Received += async (model, ea) =>
				{
					try
					{
						...
						dto = JsonConvert.DeserializeObject<PurchaseReturnDispatchTransactionDto>(message);
