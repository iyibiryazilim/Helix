...
namespace Helix.LBSService.EventConsumer.PurchaseDispatch
{
	public class PurchaseDispatchTransactionConsumer :IDisposable
	{
		...
		public PurchaseDispatchTransactionConsumer(ILG_PurchaseDispatchTransactionService purchaseDispatchTransactionService, HttpClient httpClient)
		{
		...
		private async Task<bool> PostDtoToApiAsync(PurchaseDispatchTransactionDto dto)
		{
			try
			{
