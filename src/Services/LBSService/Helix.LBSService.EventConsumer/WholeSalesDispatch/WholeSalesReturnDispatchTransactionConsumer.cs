...
namespace Helix.LBSService.EventConsumer.WholeSalesDispatch
{
	...
	{
		ILG_WholeSalesReturnDispatchTransactionService _wholeSalesReturnDispatchTransactionService;
		...
		public WholeSalesReturnDispatchTransactionConsumer(ILG_WholeSalesReturnDispatchTransactionService wholeSalesReturnDispatchTransactionService, HttpClient httpClient)
		{
		...
		private async Task<bool> PostDtoToApiAsync(WholeSalesReturnTransactionDto dto)
		{
			try
			{
		...
		private void GetMessageFromQueue()
		{
			try
			{
				...
				WholeSalesReturnTransactionDto dto = new WholeSalesReturnTransactionDto();
				...
				consumer.Received += async (model, ea) =>
				{
					try
					{
						...
						dto = JsonConvert.DeserializeObject<WholeSalesReturnTransactionDto>(message);
