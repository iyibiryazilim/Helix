...
namespace Helix.LBSService.EventConsumer.WholeSalesDispatch
{
	...
	{
		ILG_WholeSalesDispatchTransactionService _wholeSalesDispatchTransactionService;
		...
		public WholeSalesDispatchTransactionConsumer(ILG_WholeSalesDispatchTransactionService wholeSalesDispatchTransactionService, HttpClient httpClient)
		{
		...
		private async Task<bool> PostDtoToApiAsync(WholeSalesDispatchTransactionDto dto)
		{
			try
			{
		...
		private void GetMessageFromQueue()
		{
			try
			{
				...
				WholeSalesDispatchTransactionDto dto = new WholeSalesDispatchTransactionDto();
				...
				consumer.Received += async (model, ea) =>
				{
					try
					{
						...
						dto = JsonConvert.DeserializeObject<WholeSalesDispatchTransactionDto>(message);
