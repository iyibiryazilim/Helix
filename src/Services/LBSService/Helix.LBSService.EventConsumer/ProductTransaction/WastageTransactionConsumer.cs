...
namespace Helix.LBSService.EventConsumer.ProductTransaction
{
	public class WastageTransactionConsumer : IDisposable
	{
		...
		public WastageTransactionConsumer(ILG_WastageTransactionService wastageTransactionService, HttpClient httpClient)
		{
		...
		private async Task<bool> PostDtoToApiAsync(WastageTransactionDto dto)
		{
			try
			{
