...
namespace Helix.LBSService.EventConsumer.ProductTransaction
{
	public class TransferTransactionConsumer : IDisposable
	{
		...
		public TransferTransactionConsumer(ILG_TransferTransactionService wastageTransactionService, HttpClient httpClient)
		{
		...
		private async Task<bool> PostDtoToApiAsync(TransferTransactionDto dto)
		{
			try
			{
