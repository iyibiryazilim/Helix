...
namespace Helix.LBSService.EventConsumer.ProductTransaction
{
	public class InCountingTransactionConsumer : IDisposable
	{
		...
		private string _queueName = "ProductService.InCountingTransactionIns"; //gonna change
		private string _exchange = "HelixTopicName";

		public InCountingTransactionConsumer(ILG_InCountingTransactionService inCountingTransactionService, HttpClient httpClient)
		{
		...
		private async Task<bool> PostDtoToApiAsync(InCountingTransactionDto dto)
		{
			try
			{
