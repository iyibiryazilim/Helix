...
namespace Helix.LBSService.Tiger.DataStores
{
	public class LG_SalesOrderDataStore : ILG_SalesOrderService
	{
		...
		IEventBus _eventBus;
		ILogger<LG_SalesOrderDataStore> _logger;
		public LG_SalesOrderDataStore(ILogger<LG_SalesOrderDataStore> logger, IUnityApplicationService unityApplicationService, IEventBus eventBus)
		{
