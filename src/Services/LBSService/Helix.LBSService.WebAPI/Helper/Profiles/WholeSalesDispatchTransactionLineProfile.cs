...
{
	public class WholeSalesDispatchTransactionLineProfile : Profile
	{
		public WholeSalesDispatchTransactionLineProfile()
		{
	 ...
	 .ForMember(d => d.SOURCEINDEX, o => o.MapFrom(s => s.WarehouseNumber));
			...
			CreateMap<WholeSalesDispatchTransactionLineDto, LG_STLINE>()
