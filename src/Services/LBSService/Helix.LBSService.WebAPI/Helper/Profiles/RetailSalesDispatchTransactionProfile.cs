...
{
	public class RetailSalesDispatchTransactionProfile : Profile
	{
		public RetailSalesDispatchTransactionProfile()
		{
			...
			CreateMap<RetailSalesDispatchTransactionDto, LG_STFICHE>()
