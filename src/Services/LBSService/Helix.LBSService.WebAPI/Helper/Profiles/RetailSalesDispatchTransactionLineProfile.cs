...
{
	public class RetailSalesDispatchTransactionLineProfile : Profile
	{
		public RetailSalesDispatchTransactionLineProfile()
		{
		 ...
		 .ForMember(d => d.SOURCEINDEX, o => o.MapFrom(s => s.WarehouseNumber));
			...
			CreateMap<RetailSalesDispatchTransactionLineDto, LG_STLINE>()
