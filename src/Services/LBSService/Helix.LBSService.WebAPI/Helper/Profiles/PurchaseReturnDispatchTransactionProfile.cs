...
{
	public class PurchaseReturnDispatchTransactionProfile : Profile
	{
        public PurchaseReturnDispatchTransactionProfile()
        {
			...
			CreateMap<PurchaseReturnDispatchTransactionDto, LG_STFICHE>()
