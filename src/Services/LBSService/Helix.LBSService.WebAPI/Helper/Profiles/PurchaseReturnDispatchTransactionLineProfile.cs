...
{
	public class PurchaseReturnDispatchTransactionLineProfile : Profile
	{
		public PurchaseReturnDispatchTransactionLineProfile()
		{
			...
			CreateMap<PurchaseReturnDispatchTransactionLineDto, LG_STLINE>()
