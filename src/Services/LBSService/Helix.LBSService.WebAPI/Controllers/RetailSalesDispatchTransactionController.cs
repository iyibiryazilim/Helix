...
namespace Helix.LBSService.WebAPI.Controllers
{
	...
	public class RetailSalesDispatchTransactionController : ControllerBase
	{
		...
		public RetailSalesDispatchTransactionController(ILogger<RetailSalesDispatchTransactionController> logger, IRetailSalesDispatchTransactionService service, IEventBus eventBus)
		{
			_logger = logger;
			_service = service;
			_eventBus = eventBus;
