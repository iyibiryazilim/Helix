...
namespace Helix.LBSService.WebAPI.Controllers
{
	...
	public class PurchaseReturnDispatchTransactionController : ControllerBase
	{
		...
		public PurchaseReturnDispatchTransactionController(ILogger<PurchaseReturnDispatchTransactionController> logger, IPurchaseReturnDispatchTransactionService service, IEventBus eventBus)
		{
			_logger = logger;
			_service = service;
			_eventBus = eventBus;
